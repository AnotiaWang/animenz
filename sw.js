...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-9a500b","is-html-9a500b","is-jsdelivr-9a500b","is-gtm-9a500b","is-gravatar-9a500b","is-theme-9a500b","is-json-9a500b"];
      return Promise.all(
        names
