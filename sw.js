...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-97b8a0","is-html-97b8a0","is-jsdelivr-97b8a0","is-gtm-97b8a0","is-gravatar-97b8a0","is-theme-97b8a0","is-json-97b8a0"];
      return Promise.all(
        names
