...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-3b2ca6","is-html-3b2ca6","is-jsdelivr-3b2ca6","is-gtm-3b2ca6","is-gravatar-3b2ca6","is-theme-3b2ca6","is-json-3b2ca6"];
      return Promise.all(
        names
